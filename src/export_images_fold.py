...
def set_bbox(imname, path_images, path_pred, path_targ):
    ...
    try:
        ...
        print(f"Image with detections: {obj}")
        
    cv2.imwrite(f'predictions/{imname}', image)
...
if __name__ == '__main__':
    ...
    for image in images:
        set_bbox(image, path_images, path_pred, path_targ)